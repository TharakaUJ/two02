...
if (isTouchOnlyDevice) {
    ...
    addScript('/assets/js/mobile-non-hover.js');
    addScript('/assets/js/three-mobile.js', "module");
} else {
    // This is not a touch-only device, like a desktop with touch support
    addScript('/assets/js/dekstop-hover.js', "module");
    addScript('/assets/js/three-desktop.js', "module");
}
